...
- (void)viewDidLoad
{
    ...
    self.title = @"Some of My Favorite Albums";
    NSArray *listArray = [[NSArray alloc] initWithObjects: @"Umineko no Naku koro ni Chiru", @"Kara no Kyoukai Music Collection", @"Red Moon", @"Attack on Titan Original Soundtrack II", nil];
    self.list = listArray;
